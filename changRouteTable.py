...
def replace_route(session, route_table_id, destination_cidr_block, vpc_peering_connection_id):
...
def process_route_table(session, route_table, destination_cidr_blocks, vpc_peering_connection_id):
    ...
    for destination_cidr_block in destination_cidr_blocks:
        for route in route_table['Routes']:
            if route.get('DestinationCidrBlock') == destination_cidr_block:
                result = replace_route(session, route_table_id, destination_cidr_block, vpc_peering_connection_id)
...
vpc_peering_connection_id = 'pcx-xxxxxxxxxxxxxxxx'
...
for route_table in route_tables_a:
    tasks.append((session_a, route_table, destination_cidr_blocks_a, vpc_peering_connection_id))
for route_table in route_tables_b:
    tasks.append((session_b, route_table, destination_cidr_blocks_b, vpc_peering_connection_id))
